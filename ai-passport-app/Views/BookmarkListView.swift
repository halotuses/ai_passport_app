...
struct BookmarkListView: View {
    ...
    @AppStorage(AppSettingsKeys.bookmarkShowCorrectAnswers) private var isShowingCorrectAnswers = true
...
private extension BookmarkListView {
    ...
    @ViewBuilder
    func bookmarkAnswerNote() -> some View {
        Text("ブックマークした問題の正解は、設定画面で表示・非表示を設定できます。")
            .font(.footnote)
            .foregroundColor(.themeTextSecondary)
